...
Получаение на почту ссылки для оплаты по счету
...
* Шаги:
1. Открыть почту
2. Перейти по ссылке для оплаты по счету


* Ожидаемый результат:
1. Открылась страница оплаты заказа по счету
...
| 2   | 2023-08-29 | 14:53 |Chrome 116.0.5845.97 Yandex 23.7.3.823| FAIL https://trello.com/c/ouWq9d2l/297 | Chrome 116.0.5845.97               | FAIL https://trello.com/c/ouWq9d2l/297  | 27.08 | Сабина  |
