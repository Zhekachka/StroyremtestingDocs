* Тестовые данные:
Появление модального окна при успешной оплате заказа через карту
...
* Шаги:
1. Открыть почту
2. Перейти по ссылке для оплаты картой
...
| --- | ---------- | ----- |-------------------------------------| ---------------------------------- | ---------------------------------- | ---------------------------------- | ------| ------  |
| 1   | 2023-07-28 | 11:36 |Chrome 115.0.5790.102/Firefox 115.0.2 | FAIL https://trello.com/c/BDUwJZEy/178 / https://trello.com/c/ouWq9d2l/297  | Safari                            | FAIL https://trello.com/c/BDUwJZEy/178 / https://trello.com/c/ouWq9d2l/297 | 04.07 | Мария  |
