* Тестовые данные: позитивная проверка расчета доставки весом до 5000 кг. в зеленой зоне
* Предусловие:
...
* Ожидаемый результат: в поле вариант доставки отображаются следующие цены: Стандартная 2500 руб., Точно ко времени 4990 руб.,  Круглосуточная 5480 руб.
...
| --- | --- | --- | --- |  --- | --- | --- | --- |   
| 2023-08-31 | 16:24 | Яндекс Браузер версия 23.7.0.2526 | PASS | Chrome версия 116.0.5845.92 EMUI 12.0.0 | PASS  | 2023-08-27 | Евгения |
